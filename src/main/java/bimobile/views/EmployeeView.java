...
/**
 * Die Hauptansicht für die Mitarbeiterverwaltung.
 *
 * Zeigt eine Liste aller Mitarbeiter
 * sowie das zugehörige Änderungsprotokoll an.
 * Ermöglicht das Anlegen, Bearbeiten, Deaktivieren und Löschen von Mitarbeitern.
 *
...
public class EmployeeView extends VerticalLayout {
    ...
    public EmployeeView(EmployeeController controller,
        ...
        // Sicherheitscheck: Nur Management und Branch Manager dürfen hier rein
        ...
        // Branch Manager ohne Standort abfangen
    ...
    private void configureLogGrid() {
        ...
        logGrid.addColumn(log -> {
            if (log.getEmployee() != null) return log.getEmployee().getLastname() + ", " + log.getEmployee().getName();
    ...
    private void toggleEmployeeStatus(Employee employee) {
        // Berechtigungsprüfung: Manager dürfen keine Vorgesetzten deaktivieren
        if (isBranchManager) {
